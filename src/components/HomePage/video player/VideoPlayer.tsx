...
import "../../../styles/Sass/VideoPlayer.sass";
      ...
      <div className="video-container">
        ...
        <div className="container">
          <div className="bannerContent">
            <div className="Hd">DAYOUT HOLYDAYS</div>
            <div className="subHd">Delivering your Travel Experiences ....</div>
            ...
            <div className="item">
              <div className="conterBx">
                <div className="icon">
                  ...
                  >
                    <path
                      d="M54.4952 22.2055C51.3931 18.7574 49.6696 13.9318 49.6696 13.9318C49.6696 13.9318 47.9461 18.7574 44.843 22.2055C44.843 22.2055 46.2648 22.9375 47.0411 22.5493C47.0411 22.5493 46.2648 25.5238 42.7746 29.4454C45.8767 30.3061 48.2035 28.8844 48.2035 28.8844V33.1509H49.3246H50.0135H51.1357V28.8844C51.1357 28.8844 53.4615 30.3061 56.5636 29.4454C53.0733 25.5238 52.2991 22.5493 52.2991 22.5493C53.0733 22.9375 54.4952 22.2055 54.4952 22.2055Z"
                      fill="#F2A90D"
                    />
                    <path
                    ...
                    />
                    <path
                      d="M11.5343 42.5165C11.5343 42.5165 14.6274 44.4071 18.7521 43.2628C14.1115 38.0479 13.0808 34.0942 13.0808 34.0942C14.1115 34.6099 16.002 33.6366 16.002 33.6366C11.8773 29.0523 9.5857 22.6359 9.5857 22.6359C9.5857 22.6359 7.294 29.0523 3.16832 33.6366C3.16832 33.6366 5.05866 34.6099 6.09046 34.0942C6.09046 34.0942 5.05877 38.0479 0.418121 43.2628C4.54281 44.4071 7.63691 42.5165 7.63691 42.5165V48.1889H9.12721H10.0432H11.5345V42.5165H11.5343Z"
                      fill="#F2A90D"
                    />
                    <path
                      d="M51.1536 9.90937C51.2365 9.7565 51.2274 9.56547 51.1294 9.41863L48.4259 5.36422C48.3205 5.20433 48.3205 4.99521 48.4259 4.83422L51.1294 0.780908C51.2275 0.633084 51.2365 0.444027 51.1536 0.289184C51.069 0.134342 50.9071 0.0367432 50.7311 0.0367432H38.1241V10.1636H50.7311C50.9071 10.1637 51.0686 10.0641 51.1536 9.90937Z"
                      fill="#F2A90D"
                    />
                  </svg>
                </div>
            ...
            <div className="item">
              <div className="conterBx">
                <div className="icon">
                  ...
                  >
                    <path
                      d="M0.085144 15.8437V29.0645C0.085144 32.1926 2.62088 34.7282 5.74884 34.7282H39.731C42.8591 34.7282 45.3947 32.1926 45.3947 29.0645V15.8437C45.3428 15.8473 45.2903 15.8492 45.2375 15.8492H0.242469C0.189534 15.8492 0.137068 15.8473 0.085144 15.8437Z"
                      fill="#F2A90D"
                    />
                    <path
                      d="M45.3949 12.0789V6.40969C45.3949 3.28171 42.8593 0.745972 39.7312 0.745972H5.74903C2.62106 0.745972 0.0853271 3.28171 0.0853271 6.40969V12.0789C0.137251 12.0753 0.189717 12.0734 0.242652 12.0734H45.2377C45.2905 12.0734 45.343 12.0753 45.3949 12.0789Z"
                      fill="#F2A90D"
                    />
                  </svg>
                </div>
                ...
                <div className="icon">
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M22.0318 33.243C18.0709 33.243 14.0467 30.8917 11.6982 27.7795C0.430575 27.7795 0.0899658 43.8761 0.0899658 43.8761H43.971C43.971 43.8761 44.8554 27.7081 32.1842 27.7081C29.8384 30.8587 25.9928 33.243 22.0318 33.243Z"
                      fill="#F2A90D"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M31.4703 13.9464C31.4703 18.5776 27.2428 27.4335 22.0238 27.4335C16.813 27.4335 12.5829 18.5748 12.5829 13.9464C12.5829 9.31789 16.8103 5.56018 22.0238 5.56018C27.2428 5.56293 31.4703 9.32064 31.4703 13.9464Z"
                      fill="#F2A90D"
                    />
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M35.6834 9.94962C35.6834 9.08161 34.4748 8.38116 32.975 8.37567V6.58746C32.975 6.32101 33.0767 0.0828857 22.0563 0.0828857C11.0414 0.0828857 11.143 6.32101 11.143 6.58746V8.43885C11.1156 8.43885 11.0936 8.43061 11.0689 8.43061C9.57733 8.43061 8.37695 9.12007 8.37695 9.97434V17.5392C8.37695 18.388 9.58008 19.0802 11.0689 19.0802C12.5577 19.0802 13.7663 18.388 13.7663 17.5392V9.97434C13.7663 9.85623 13.6921 9.7491 13.6482 9.63923V7.57633C13.6482 7.3868 12.8571 2.67867 22.0563 2.67867C31.2582 2.67867 30.3023 7.3868 30.3023 7.57633V9.7491C30.2859 9.81777 30.2337 9.8782 30.2337 9.94962V17.6875C30.2337 18.5583 31.4505 19.2642 32.9585 19.2642C32.9915 19.2642 33.0162 19.2533 33.0492 19.2533V22.0798H30.3463V24.7442H35.7109L35.6834 9.94962Z"
                      fill="#F2A90D"
                    />
                  </svg>
                </div>
            ...
            <div className="lft">
              <div className="innerBx">
                ...
                <div className="cont">
                  ...
                  <div className="hd">Place Of Enjoyment</div>
                  <p>
                    Day out Company is the best travel agency in goa, to satisfy
                    your dream plan in goa then choose our service to provide
                    you 100% statisfication.Goa trip is a perfect heaven for the
                    ones who need and want relaxation. Goa Beach Resorts always
                    add to the fun.Tour packages at best price available in
                    goacalling. Here we provide all types of vechicle which will
                    fulfill your needs.The cabs are air-conditioned, have panic
                    buttons and all drivers trained in self-defence and
                    first-aid
                  </p>
                </div>
              </div>
      ...
      <div className="pacakage">
        <div className="container">
          <div className="tleWrap">
            ...
            <p>
              Discover our carefully curated travel packages, tailored to
              fulfill your wanderlust. From serene beach escapes to thrilling
              mountain adventures and immersive city tours, each package offers
              handpicked accommodations and exclusive experiences for an
              unforgettable journey. Explore with confidence and convenience,
              knowing every detail has been crafted with your travel pleasure in
              mind.
            </p>
          </div>
        </div>
            ...
            <div className="dFlex">
              <div className="item">
                <a href="#!" className="packageBx">
                  <div className="imgWrap">
                    <div className="imgBx">
                      <img src={packge001} alt="images" />
                    </div>
                    <div className="tleBx">
                      <div className="hd">Baga Beach</div>
                    </div>
                    <div className="contBx">
                      <div className="tle">Baga Beach</div>
                      <div className="info">
                        Qui ut ceteros comprehensam. Cu eos sale sanctus
                        eligendi, id ius elitr saperet,ocurreret pertinacia pri
                        an. No mei nibh consectetuer
                      </div>
              ...
              <div className="item">
                <a href="#!" className="packageBx">
                  <div className="imgWrap">
                    <div className="imgBx">
                      <img src={packge002} alt="images" />
                    </div>
                    <div className="tleBx">
                      <div className="hd">Candolim Beach</div>
                    </div>
                    <div className="contBx">
                      <div className="tle">Candolim Beach</div>
                      <div className="info">
                        Qui ut ceteros comprehensam. Cu eos sale sanctus
                        eligendi, id ius elitr saperet,ocurreret pertinacia pri
                        an. No mei nibh consectetuer
              ...
              <div className="item">
                <a href="#!" className="serviceBx">
                  <div className="iconBx">
                    ...
                    >
                      <path
                        d="M33.6958 15.552V46.6559H38.8798V77.7599C38.8798 80.8703 40.9534 82.9439 44.0638 82.9439C47.1742 82.9439 49.2478 80.8703 49.2478 77.7599V0C40.435 0 33.6958 6.73919 33.6958 15.552Z"
                        fill="white"
                      />
                      <path
                        d="M69.9839 5C62.7263 5 57.0239 12.776 57.0239 22.1072C56.5055 28.328 59.6159 34.0304 64.7999 37.6592V72.3919C64.7999 75.5023 66.8735 77.5759 69.9839 77.5759C73.0943 77.5759 75.1679 75.5023 75.1679 72.3919C75.1679 69.2815 75.1679 37.6592 75.1679 37.6592C80.3519 34.0304 83.4623 28.328 82.9439 22.1072C82.9439 12.776 77.2415 5 69.9839 5Z"
                        fill="white"
                      />
                      <path
                        d="M23.328 6C21.7728 6 20.736 7.5552 20.736 8.592V21.552H15.552V8.592C15.552 7.0368 14.5152 6 12.96 6C11.4048 6 10.368 7.5552 10.368 8.592V21.552H5.18399V8.592C5.18399 7.0368 4.14719 6 2.592 6C1.0368 6 0 7.5552 0 8.592V25.6992C0 30.3648 3.62879 33.9936 7.77599 34.512V70.7999C7.77599 73.9103 9.84959 75.9839 12.96 75.9839C16.0704 75.9839 18.144 73.9103 18.144 70.7999V34.512C22.2912 33.9936 25.92 30.3648 25.92 25.6992V8.592C25.92 7.5552 24.8832 6 23.328 6Z"
                        fill="white"
                      />
                    </svg>
                  </div>
                  <div className="name">Food Services</div>
                  <div className="sName">Catering</div>
                </a>
              </div>
              <div className="item">
                <a href="#!" className="serviceBx">
